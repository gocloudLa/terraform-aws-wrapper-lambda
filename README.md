...
| logging_application_log_level                | The application log level of the Lambda Function. Valid values are "TRACE", "DEBUG", "INFO", "WARN", "ERROR", or "FATAL".                                                                                                                                                      | `string` | `null`         | no       |
...
| logging_system_log_level                     | The system log level of the Lambda Function. Valid values are "DEBUG", "INFO", or "WARN".                                                                                                                                                                                      | `string` | `null`         | no       |
